...
// */
//public class BoardT extends JPanel implements MouseListener, MouseMotionListener
//{
...
//	 */
//	public BoardT(RaiNetMain parentFrame)
//	{
...
//			{
//				selectedPiece=nextTile.removePiece();
//				
...
////					if (((Movable)selectedPiece).canMoveTo(nextTile))
////						{
////						//nextTile.addPiece(selectedPiece);
////						selectedPiece=null;
////							//((Movable)selectedPiece).moveTo(nextTile);
...
//		board[1][1].addPiece(new CardPiece(board[1][1].position,true,1));
//		// Resets the hands.
...
//			((CardPiece) selectedPiece).setPosition(currentPoint);
